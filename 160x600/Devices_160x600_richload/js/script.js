...
var Advert = {
	...
	setAnim: function()
	{
		...
		_this.timeline.to("#section1", 0.5, {left:"-300px",rotation:45, ease: Quint.easeIn}, "+=2.3");
		...
		_this.timeline.from("#tagSlide", 0.9, {bottom:"-500px",rotation:30, ease: Quint.easeOut}, "-=0.5");
	...
	bubbleBounce: function(root) { 
		...
		var cta_x	= parseFloat( cta.offsetLeft );
		...
		TweenLite.delayedCall( 1.2, function() { 
			...
			TweenLite.set(bubblesHolder , { x : cta_x + cta.offsetWidth - 10});
		...
		TweenLite.delayedCall(2 , function() { 
			...
			document.onmousemove = function( event ) {
			  ...
			  moveX = event.pageX;
			  moveY = event.pageY;
			  scale = ( 600 - event.pageY ) * scalability;
